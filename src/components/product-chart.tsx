  ...
  return (
    <div className="h-48 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 5, left: 20, right: 30, bottom: 5 }}>
          ...
          <Area type="monotone" dataKey="products" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.2} strokeWidth={2}  dot={{fill :"#8b5cf6",strokeWidth:2,r:4}} activeDot={{fill :"#8b5cf6",strokeWidth:2,r:4}}/>
          <Tooltip 
            contentStyle={{
            ...
            labelStyle={{color :"#3741541",fontWeight:"500"}}
          />
        </AreaChart>
      </ResponsiveContainer>
    </div>
